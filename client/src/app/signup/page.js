                    ...
                    {loading ? (
                        <div className='w-screen h-[70vh] flex flex-col justify-center items-center'>
                            <div className="flex flex-col items-center space-x-2">
                                ...
                                <span className="text-gray-500 mt-2">Creating A User...</span>
                            </div>
                        </div>
                    ) :
                        <div className="rounded-lg p-4 flex flex-col m-auto mt-10 md:mt-0 sm:w-[80vw]">
                            ...
                            <button className="text-white bg-black  py-2 px-8 text-sm w-32  hover:bg-white hover:text-black border-2 border-black hover:-translate-y-2 duration-200 ease-in-out" onClick={postData}>Sign Up</button>
                            <p className="text-xs text-gray-500 mt-3">Already Have An Account ? <Link className='text-blue-700 cursor-pointer hover:underline font-semibold' href={'/login'}>Login</Link></p>
                        </div>
                    }
                </form>
                <ToastContainer />
